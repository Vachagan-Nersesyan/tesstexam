...
const FinalTestComp = () => {
    ...
    return (<div className={finalTestStl_module_css_1.default.test_content_overlay}>
            <div className={finalTestStl_module_css_1.default.test_content}>
                ...
                <div className={finalTestStl_module_css_1.default.test_content_second_content}>
                    <div className={finalTestStl_module_css_1.default.test_content_second_content_1}>
                        <img src={_1_png_1.default} alt=""/>
                    </div>
                    <div className={finalTestStl_module_css_1.default.test_content_second_content_2}>
                        <div className={finalTestStl_module_css_1.default.test_content_second_content_2_1}></div>
                    </div>
                </div>
                <div className={finalTestStl_module_css_1.default.test_content_container}>
                    <div className={finalTestStl_module_css_1.default.test_content_third_content}>
                        ...
                        {/* second part */}
                        <div className={finalTestStl_module_css_1.default.test_content_third_content_2}>
                            <div className={finalTestStl_module_css_1.default.test_content_third_content_2_1}>
                                <div className={finalTestStl_module_css_1.default.test_content_third_content_2_1_1}>
                                    Թեստ N
                                </div>
                        ...
                        <div className={finalTestStl_module_css_1.default.ss}>
                                    ...
                                    <>
                                            ...
                                            if (ind < num) {
                                                ...
                                                return (<>
                                                        ...
                                                        : null}
                                                                                                            <div key={ind} className={finalTestStl_module_css_1.default.test_content_third_content_3_2_3_1}>
                                                                                                                <div className={finalTestStl_module_css_1.default.test_content_third_content_3_2_3_1_1}>
                                                                                                                    {countBg}
                                                                                                                </div>
                        ...
                        return (<>
                                ...
                                if (forthNum === 1) {
                                    ...
                                    return (<>
                                            ...
                                            :
                                                null}
                                                                                        <div className={finalTestStl_module_css_1.default.test_content_third_content_3_tdwe}>
                                                                                            {ind === 0
                                            ?
            ...
            arrInfo.map((val) => {
                ...
                {/* artagreq part */}
                <div className={finalTestStl_module_css_1.default.last_part_content}>
                    <div className={finalTestStl_module_css_1.default.last_part_content_1_item}>
                        <div className={finalTestStl_module_css_1.default.last_part_content_1_item_1}>
                            Արտագրե՜ք այս նախադասությունը՝
                        </div>
                        <div className={finalTestStl_module_css_1.default.last_part_content_1_item_2}>
