...
const makeTest_1 = __importDefault(require("pages/makeTest"));
...
const App = () => {
    return (<div className={App_module_css_1.default.App}>
      <react_router_dom_1.Routes>
        <react_router_dom_1.Route path='/' element={<LoginComp />}/>

        <react_router_dom_1.Route path='/test-items' element={<TestComp />}/>
        <react_router_dom_1.Route path='/test' element={<FinalTestComp />}/>
        <react_router_dom_1.Route path='/new-test' element={<makeTest_1.default />}/>
        <react_router_dom_1.Route path='/all-exams' element={<WorkspaceComp />}/>
